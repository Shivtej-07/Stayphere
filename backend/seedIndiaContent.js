    ...
    try {
        ...
        const destinations = [
            ...
            // Indian Destinations with Real Images
            {
                ...
                photos: ['https://images.unsplash.com/photo-1616859353916-2c938c5c7d0e?auto=format&fit=crop&w=800&q=80'], // Authentic Kedarnath
                featured: true,
            },
            {
                ...
                // Selected generic mountain/temple view as specific nice Badrinath is rare on Unsplash, closest atmospheric match
                photos: ['https://images.unsplash.com/photo-1626245199613-207d58933bc6?auto=format&fit=crop&w=800&q=80'],
                featured: true,
            },
            {
                name: 'Golden Temple, Amritsar',
                description: 'The holiest Gurdwara of Sikhism, also known as Sri Harmandir Sahib.',
                photos: ['https://images.unsplash.com/photo-1514222134-b57cbb8ce073?auto=format&fit=crop&w=800&q=80'], // Iconic Golden Temple
                featured: true,
            },
            {
                name: 'Tirupati Balaji, Andhra Pradesh',
                description: 'A landmark Vaishnavite temple dedicated to Lord Venkateswara.',
                photos: ['https://images.unsplash.com/photo-1669046756857-e6f663a8244b?auto=format&fit=crop&w=800&q=80'], // Tirupati Gopuram
                featured: true,
            },
            {
                name: 'Rameswaram Temple, Tamil Nadu',
                description: 'A Hindu temple dedicated to the god Shiva located on Rameswaram island.',
                // Temple Corridor Architecture 
                photos: ['https://images.unsplash.com/photo-1628151015968-3a4429e9ef04?auto=format&fit=crop&w=800&q=80'],
                featured: true,
            },
            {
                name: 'Konark Sun Temple, Odisha',
                description: 'A 13th-century CE Sun Temple at Konark, dedicated to the Hindu sun god Surya.',
                photos: ['https://images.unsplash.com/photo-1598207951491-255eaf13b376?auto=format&fit=crop&w=800&q=80'], // Konark Wheel
                featured: false,
            },
            // NEWLY ADDED TEMPLES
            {
                ...
                photos: ['https://images.unsplash.com/photo-1644302258836-8aed59937172?auto=format&fit=crop&w=800&q=80'], // Meenakshi Gopuram
                featured: true,
            },
            {
                ...
                photos: ['https://images.unsplash.com/photo-1600100598004-94b29bb64525?auto=format&fit=crop&w=800&q=80'], // Hampi Virupaksha
                featured: true,
            },
            {
                name: 'Prem Mandir, Vrindavan',
                description: 'A massive temple complex related to Radha Krishna and Sita Ram.',
                photos: ['https://images.unsplash.com/photo-1678788931557-ca5e7f0c4515?auto=format&fit=crop&w=800&q=80'], // Prem Mandir lighting
                featured: true,
            },
            {
                name: 'Somnath Temple, Gujarat',
                description: 'The first among the twelve Jyotirlinga shrines of Shiva.',
                photos: ['https://images.unsplash.com/photo-1628522384964-b81628d01d4a?auto=format&fit=crop&w=800&q=80'], // Somnath or similar shore temple style
                featured: false,
            }
        ];
